...
class TestBooksColle:
    ...
    def books_with_different_genres():
        return [['Гордость и предубеждение и зомби','Фантастика'],['Сияние','Ужасы'],['Шерлок Холмс','Детективы'],['Смешарики','Мультфильмы'],['Собачье сердце','Комедии']]
    ...
    def test_get_books_genre_returned_dict(self,collector):
        ...
        assert result == {'Преступление и наказание':'Фантастика','Смешарики':'Мультфильмы'}
    ...
    def test_get_list_of_favorites_books_shown_favorite_books(self,collector):
        ...
        assert 'Гордость и предубеждение и зомби' in result and 'Хорошая книга' in result
